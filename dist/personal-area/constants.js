...
exports.SITE_THEMES = exports.SITE_SCALES = exports.PA_TYPOGRAPHY = exports.PA_TRANSITIONS = exports.PA_SPACING = exports.PA_SHADOWS = exports.PA_RADIUS = exports.PA_COLORS = void 0;
// CRM KIT — PersonalArea design tokens

var PA_SPACING = exports.PA_SPACING = {
  xs: 4,
  sm: 8,
  md: 16,
  lg: 24,
...
var PA_RADIUS = exports.PA_RADIUS = {
  sm: 8,
  md: 12,
  lg: 16,
  xl: 24,
...
var PA_SHADOWS = exports.PA_SHADOWS = {
...
var PA_COLORS = exports.PA_COLORS = {
  pageBg: '#F5F6F8',
  cardBg: '#FFFFFF',
  cardBorder: '#ECEEF2',
  sectionBg: '#F8F9FB',
...
var PA_TYPOGRAPHY = exports.PA_TYPOGRAPHY = {
...
var PA_TRANSITIONS = exports.PA_TRANSITIONS = {
  micro: 'all 0.1s ease',
...
var SITE_THEMES = exports.SITE_THEMES = {
  "default": {
    id: 'default',
    label: 'ברירת מחדל',
...
var SITE_SCALES = exports.SITE_SCALES = [{
  value: 90,
  label: '90%',
  description: 'קטן'
}, {
