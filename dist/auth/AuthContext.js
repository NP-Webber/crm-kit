...
var AuthContext = /*#__PURE__*/(0, _react.createContext)(null);
...
var AuthProvider = exports.AuthProvider = function AuthProvider(_ref) {
  var children = _ref.children,
    ...
    _ref$loginEndpoint = _ref.loginEndpoint,
    loginEndpoint = _ref$loginEndpoint === void 0 ? '/auth/login' : _ref$loginEndpoint,
    _ref$logoutEndpoint = _ref.logoutEndpoint,
    logoutEndpoint = _ref$logoutEndpoint === void 0 ? '/auth/logout' : _ref$logoutEndpoint,
    _ref$storagePrefix = _ref.storagePrefix,
    storagePrefix = _ref$storagePrefix === void 0 ? 'crm' : _ref$storagePrefix,
    onLoginSuccess = _ref.onLoginSuccess,
    onLogoutCallback = _ref.onLogoutCallback;
  var tokenKey = "".concat(storagePrefix, "_accessToken");
  var refreshKey = "".concat(storagePrefix, "_refreshToken");
  var userKey = "".concat(storagePrefix, "_user");
  ...
  (0, _react.useEffect)(function () {
    ...
    var storedUser = localStorage.getItem(userKey);
    if (token && storedUser) {
      try {
  ...
  var login = (0, _react.useCallback)(/*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(username, password) {
      var _yield$apiClient$post, data;
      return _regenerator().w(function (_context) {
        while (1) switch (_context.n) {
          case 0:
            ...
            throw new Error('apiClient is required for AuthProvider');
          case 1:
            _context.n = 2;
  ...
  var logout = (0, _react.useCallback)(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
    var refreshToken, _t;
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        case 0:
          ...
          _context2.n = 1;
          return apiClient.post(logoutEndpoint, {
  ...
  var hasPermission = (0, _react.useCallback)(function (resource, action) {
    var _user$roles;
    if (!user) return false;
    if ((_user$roles = user.roles) !== null && _user$roles !== void 0 && _user$roles.includes('admin')) return true;
    return true;
  }, [user]);
  var value = {
    user: user,
